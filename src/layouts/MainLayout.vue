    ...
    <q-header elevated>
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <q-btn round dense flat color="white" icon="fab fa-github" type="a" href="https://github.com/" target="_blank">
          </q-btn>
          <q-btn round dense flat icon="fas fa-heart" style="color:#9d4182 !important;" type="a" href="https://github.com/" target="_blank">
          </q-btn>
